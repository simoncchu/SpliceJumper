...
public:
	void optAlign(int& optm_start_ref, int& optm_end_ref, int& optm_start_sgmt, int& optm_end_sgmt);
	void align(int& optm_start_ref, int& optm_end_ref, int& optm_start_sgmt, int& optm_end_sgmt, \
